...
import phunkLoveVideo from '../assets/projects/phunk-love/main-video.mov'
...
import sickOfWaitingVideo from '../assets/projects/sick-of-waiting/main-video.mov'
...
import sunwayOrientationVideo from '../assets/projects/sunway-college-orientation/main-video.mov'
import tidesCover from '../assets/projects/tides-mv-teaser/cover.jpg'
import tidesMvTeaserVideo from '../assets/projects/tides-mv-teaser/main-video.mov'
...
const media = {
  ...
  sickOfWaitingGraphicOne: {
    ...
    alt: 'Square-leaning gritty Sick of Waiting graphic design artwork',
...
const projectList = [
  {
    ...
    summary:
      'A real music teaser package built around anxious pacing, city-sunset atmosphere, rough handwritten type, and social-ready poster assets.',
    categories: ['video-editing', 'motion-design', 'graphic-design', 'social-media'],
    year: '2026',
    client: 'Sixteen Orbits',
    projectType: 'client',
    roles: ['Video Editing', 'Poster Design', 'Motion Direction'],
    tools: ['Premiere Pro', 'After Effects', 'Photoshop'],
    challenge:
      'Shape a short teaser that communicates the track mood quickly while giving the release enough visual identity for social promotion.',
    approach:
      'Matched the edit to the music energy, used restrained motion moments, and paired the teaser with gritty handwritten poster artwork.',
    outcome:
      'A compact release package with a finished teaser, campaign poster, and supporting image direction for sharing across platforms.',
    cover: media.sickOfWaitingCover,
    featuredMedia: media.sickOfWaitingVideo,
  ...
  },
  {
    ...
    summary:
      'A short orientation recap that turns event moments, campus movement, and group energy into a polished social-ready video.',
    categories: ['video-editing', 'social-media'],
    year: '2026',
    client: 'Sunway College',
    projectType: 'client',
    roles: ['Event Editing', 'Recap Editing', 'Sound Design'],
    ...
    outcome:
      'A concise event video suitable for campus channels, social posting, and future orientation promotion.',
    cover: media.sunwayOrientationCover,
    featuredMedia: media.sunwayOrientationVideo,
    gallery: [],
    featured: true,
    order: 2,
  },
  {
    ...
    categories: ['video-editing', 'motion-design'],
    year: '2026',
    client: 'Music Video Project',
    projectType: 'personal',
    roles: ['Video Editing', 'Colour Grading', 'Motion Timing'],
    tools: ['Premiere Pro', 'After Effects', 'Photoshop'],
    challenge:
      'Make the teaser feel complete in under a minute while still leaving enough curiosity for the full music video.',
    approach:
      'Focused on the strongest motion beats, tightened the progression, and let the music guide each cut and reveal.',
    outcome:
      'A focused music video teaser that can work as a release preview, story post, or portfolio motion piece.',
    cover: media.tidesCover,
    featuredMedia: media.tidesVideo,
    gallery: [],
    featured: true,
    order: 3,
  },
  {
    ...
    categories: ['video-editing', 'motion-design', 'social-media'],
    year: '2026',
    client: 'Music Teaser Project',
    projectType: 'personal',
    roles: ['Short-form Editing', 'Rhythm Editing', 'Sound Design'],
    ...
    featuredMedia: media.phunkLoveVideo,
    gallery: [],
    featured: true,
    order: 4,
  },
  {
    ...
    subtitle: 'Graphic direction for gritty music release artwork and supporting social imagery.',
    summary:
    ...
    categories: ['graphic-design', 'social-media', 'branding'],
    year: '2026',
    client: 'Sixteen Orbits',
    projectType: 'client',
    roles: ['Poster Design', 'Art Direction', 'Social Asset Design'],
    tools: ['Photoshop', 'Illustrator', 'Figma'],
    challenge:
      'Create release artwork that feels raw and memorable while still reading clearly in a social feed.',
    approach:
    ...
    outcome:
      'A usable poster and mood image set that supports the teaser campaign across thumbnails, posts, and music promotion.',
  ...
  },
  {
    ...
    summary:
      'A small set of visual identity frames used across the portfolio to support a cinematic, editing-first brand direction.',
    categories: ['graphic-design', 'branding'],
    year: '2026',
    client: 'JackNex Creative',
    projectType: 'personal',
    roles: ['Visual Direction', 'Portfolio Design', 'Brand Styling'],
