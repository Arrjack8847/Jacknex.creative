...
export function Footer() {
  ...
  return (
    <footer className="border-t border-[var(--line)] bg-black/20">
      <div className="section-shell grid gap-10 py-12 lg:grid-cols-[1fr_1fr_1fr]">
        <div>
          <Link className="mono-label text-lg font-black text-[var(--text)]" to="/">
            {siteConfig.brandName}
          </Link>
          <p className="mt-3 text-sm text-[var(--muted)]">Video Editor / Graphic Designer</p>
        ...
        <nav aria-label="Footer navigation" className="grid gap-3 sm:grid-cols-2">
          ...
          <a className="text-[var(--muted)] transition hover:text-[var(--accent)]" href={siteConfig.contact.emailHref}>
